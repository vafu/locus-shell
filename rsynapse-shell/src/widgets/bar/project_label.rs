...
use crate::providers::{ProjectLabelView, project_label_for_workspace};
use crate::schema::{WorkspaceNodeExt, model};
...
pub(super) struct ProjectLabel {
    ...
    #[source(project_label_for_workspace(workspace.id().to_owned()))]
    pub view: ProjectLabelView,
...
impl SimpleComponent for ProjectLabel {
    ...
    view! {
        gtk::Overlay {
            ...
            gtk::Box {
                #[watch]
                set_css_classes: project_group_classes(model.active, model.view.urgent),
                    ...
                    gtk::Box {
                        ...
                        gtk::Box {
                            ...
                            gtk::Label {
                                ...
                                #[watch]
                                set_label: model.view.primary.as_str(),
                            ...
                            gtk::Label {
                                ...
                                #[watch]
                                set_visible: !model.view.secondary.is_empty(),
                            ...
                            gtk::Label {
                                ...
                                #[watch]
                                set_label: model.view.secondary.as_str(),
    ...
    fn init(
        ...
        let icon = material_icon::image(&model.view.icon);
        let widgets = view_output!();

        root.add_overlay(&workspace_badge(model.view.sort_index));
